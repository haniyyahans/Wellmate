...
<!-- Sidebar -->
        <aside class="w-64 bg-white shadow-lg flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-2">  <!-- Menu -->
                <a href="berandapage.html" class="flex items-center space-x-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-lg">
                ...
                <a href="HalamanLaporan.php" class="flex items-center space-x-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-lg">
                    <i class="fas fa-chart-bar"></i>
                    <span>Laporan dan Analisis</span>
                </a>
                <a href="beritaEdukasi.html" class="flex items-center space-x-3 px-4 py-3 bg-blue-50 text-blue-600 rounded-lg">
                    <i class="fas fa-newspaper"></i>
                    <span class="font-medium">Berita dan Edukasi</span>
                </a>
            ...
            <div class="p-3 no-underline"> <!-- Logout -->
...
<!--LIST ARTIKEL-->
                ...
                <?php foreach ($berita as $b): ?> <!--$berita adalah array berisi daftar semua berita dari controller, foreach melakukan loop untuk tiap berita dan menampilkan card-nya-->
                    <a href="index.php?c=BeritaController&m=detail&id=<?= $b['id_berita'] ?>" class="block"> <!--setiap card adalah link, klo di klik akan diarahkan ke halaman dengan model dan controller tersebut-->
...
<!--ISI DETAIL ARTIKEL-->
            ...
            <div id="articleDetail" class="<?= isset($detail) ? '' : 'hidden' ?>"> <!--tampilkan detail artikel-->
                <div class="bg-white rounded-lg shadow-md p-8">
                    <a href="index.php?c=BeritaController&m=index" 
