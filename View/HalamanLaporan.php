        ...
        <aside class="w-64 bg-white shadow-lg flex flex-col">
            <div class="p-6"> <!-- Logo -->
                <div class="flex items-center space-x-2">
                    <span class="text-2xl font-bold text-gray-800">WellMate</span>
                </div>
            </div>
            <nav class="flex-1 p-4 space-y-2"> <!-- Menu -->
                ...
                <a href="index.php?c=LaporanController&m=index" class="flex items-center space-x-3 px-4 py-3 bg-blue-50 text-blue-600 rounded-lg">
                    <i class="fas fa-chart-bar"></i>
                    <span class="font-medium">Laporan dan Analisis</span>
                </a>
                <a href="index.php?c=BeritaController&m=index" class="flex items-center space-x-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-lg">
